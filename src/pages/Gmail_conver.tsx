...
//                     .from('memory_entries')
//                     // IMPORTANT CHANGE: Select 'raw_html' directly from the top level
//                     .select('id, created_at, sender, content, metadata, raw_html')
//                     .eq('id', id) // Assuming 'id' is the primary key for the memory_entry
//                     .single();
...
//                     body: data.content,
//                     // IMPORTANT CHANGE: Assign data.raw_html to originalHtml
...
//         if (!userid) {
//             return console.log('not able to retrieve data');
//         }
//         setuserid(userid);
...
export default function EmailView() {
    ...
    try {
        ...
        const mail=await fetch("http://localhost:3000/api/auth/gmail/fetch/fetchselectedmail",{
            method:"POST",
            headers:{
